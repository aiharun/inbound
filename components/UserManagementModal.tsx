          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
              ...
              <form onSubmit={handleAddSubmit} className="space-y-3">
                ...
                <button
                  type="submit"
                  className="w-full py-2 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700 transition-colors shadow-sm"
                >
                  Kullanıcı Oluştur
                </button>
              </form>
            ...
            <div>
              ...
              <div className="space-y-2">
                {users.map(user => (
                  <div key={user.username} className="flex items-center justify-between p-3 bg-white border border-slate-100 rounded-xl shadow-sm hover:border-blue-100 transition-colors">
